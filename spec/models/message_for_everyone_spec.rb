...
RSpec.describe MessageForEveryone, type: :model do
    ...
    it 'タイトルが255文字の場合有効であること' do
      message_for_everyone_with_65535_character_body = build(:message_for_everyone, body: 'a' * 65535)
    ...
    it 'タイトルが256文字の場合不正であること' do
      message_for_everyone_with_256_character_body = build(:message_for_everyone, body: 'a' * 65536)
